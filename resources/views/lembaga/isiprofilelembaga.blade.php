            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <form action="{{route('upload.lembaga')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-grup row" style="margin-bottom: 1em">
                        ...
                        <div class="col-sm-10">
                            <select name='tipe_lembaga' class="form-control" id="exampleFormControlSelect1">
                    ...
                    <div class="form-grup row" style="margin-bottom: 1em">
                        <label for="typePanti" class="col-sm-2 col-form-label">Nama Lembaga</label>
                        <div class="col-sm-10">
                            <input name='nama_lembaga' type="text" class="form-control" id="namapanti" placeholder="">
                        </div>
                    </div>
                    <div class="form-grup row" style="margin-bottom: 1em">
                        <label for="typePanti" class="col-sm-2 col-form-label">Deskripsi Lembaga</label>
                        <div class="col-sm-10">
                            <textarea name='desc_perusahaan' class="form-control " id="desc_perusahaan" rows="6" style="resize: none"></textarea>
                        </div>
                    </div>
                    <div class="form-grup row" style="margin-bottom: 1em">
                        <label for="typePanti" class="col-sm-2 col-form-label">Nomor Telepon Lembaga</label>
                        <div class="col-sm-10">
                            <input name='no_telepon_perusahaan' type="text" class="form-control" id="notelp" placeholder="">
                        </div>
                    </div>
                    <div class="form-grup row" style="margin-bottom: 1em">
                        <label for="typePanti" class="col-sm-2 col-form-label">Alamat Lembaga</label>
                        <div class="col-sm-10">
                            <textarea name='alamat_perusahaan' class="form-control " id="alamat" rows="6" style="resize: none"></textarea>
                        </div>
                    </div>
                    <div class="form-grup row" style="margin-bottom: 1em">
                    ...
                    <div class="form-grup row" style="margin-bottom: 1em">
                        <label for="typePanti" class="col-sm-2 col-form-label">Logo Lembaga</label>
                        <div class="col-sm-10">
